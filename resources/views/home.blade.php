    ...
    <div class="container-fluid bg-primary px-0 px-md-5 mb-5">
        <div class="row align-items-center px-3">
            ...
            <div class="col-lg-6 text-center text-lg-right">
                <img class="img-fluid mt-5" src="{{ url('assets/home/img/header.png') }}" alt="">
            </div>
        </div>
    </div>
    <!-- Header End -->
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-5 mb-lg-0" src="{{ url('assets/home/img/about-1.jpg') }}" alt="">
                </div>
                <div class="col-lg-7">
                    ...
                    <div class="row pt-2 pb-4">
                        <div class="col-6 col-md-4">
                            <img class="img-fluid rounded" src="{{ url('assets/home/img/about-2.jpg') }}" alt="">
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 mb-5">
                    <div class="card border-0 bg-light shadow-sm pb-2">
                        <img class="card-img-top mb-2" src="{{ url('assets/home/img/class-1.jpg') }}" alt="">
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card border-0 bg-light shadow-sm pb-2">
                        <img class="card-img-top mb-2" src="{{ url('assets/home/img/class-2.jpg') }}" alt="">
                        <div class="card-body text-center">
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card border-0 bg-light shadow-sm pb-2">
                        <img class="card-img-top mb-2" src="{{ url('assets/home/img/class-3.jpg') }}" alt="">
                        <div class="card-body text-center">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 text-center team mb-5">
                    <div class="position-relative overflow-hidden mb-4" style="border-radius: 100%;">
                        <img class="img-fluid w-100" src="{{ url('assets/home/img/team-1.jpg') }}" alt="" >
                        <div
                ...
                <div class="col-md-6 col-lg-3 text-center team mb-5">
                    <div class="position-relative overflow-hidden mb-4" style="border-radius: 100%;">
                        <img class="img-fluid w-100" src="{{ url('assets/home/img/team-2.jpg') }}" alt="" >
                        <div
                            class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute">
                            <a class="btn btn-outline-light text-center mr-2 px-0" style="width: 38px; height: 38px;"
                                href="#"><i class="fab fa-twitter"></i></a>
                ...
                <div class="col-md-6 col-lg-3 text-center team mb-5">
                    <div class="position-relative overflow-hidden mb-4" style="border-radius: 100%;">
                        <img class="img-fluid w-100" src="{{ url('assets/home/img/team-3.jpg') }}" alt="" >
                        <div
                            class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute">
                            <a class="btn btn-outline-light text-center mr-2 px-0" style="width: 38px; height: 38px;"
                                href="#"><i class="fab fa-twitter"></i></a>
                ...
                <div class="col-md-6 col-lg-3 text-center team mb-5">
                    <div class="position-relative overflow-hidden mb-4" style="border-radius: 100%;">
                        <img class="img-fluid w-100" src="{{ url('assets/home/img/team-4.jpg') }}" alt="" >
                        <div
                            class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute">
                            <a class="btn btn-outline-light text-center mr-2 px-0" style="width: 38px; height: 38px;"
                                href="#"><i class="fab fa-twitter"></i></a>
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item px-3">
                    ...
                    <div class="d-flex align-items-center">
                        <img class="rounded-circle" src="{{ url('assets/home/img/testimonial-1.jpg') }}" style="width: 70px; height: 70px;" alt="Image">
                        <div class="pl-3">
                            <h5>Parent Name</h5>
                            <i>Profession</i>
                        </div>
                ...
                <div class="testimonial-item px-3">
                    ...
                    <div class="d-flex align-items-center">
                        <img class="rounded-circle" src="{{ url('assets/home/img/testimonial-2.jpg') }}" style="width: 70px; height: 70px;" alt="Image">
                        <div class="pl-3">
                            <h5>Parent Name</h5>
                            <i>Profession</i>
                        </div>
                ...
                <div class="testimonial-item px-3">
                    ...
                    <div class="d-flex align-items-center">
                        <img class="rounded-circle" src="{{ url('assets/home/img/testimonial-3.jpg') }}" style="width: 70px; height: 70px;" alt="Image">
                        <div class="pl-3">
                            <h5>Parent Name</h5>
                            <i>Profession</i>
                        </div>
                ...
                <div class="testimonial-item px-3">
                    ...
                    <div class="d-flex align-items-center">
                        <img class="rounded-circle" src="{{ url('assets/home/img/testimonial-4.jpg') }}" style="width: 70px; height: 70px;" alt="Image">
                        <div class="pl-3">
                            <h5>Parent Name</h5>
                            <i>Profession</i>
                        </div>
            ...
            <div class="row pb-3">
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        <img class="card-img-top mb-2" src="{{ url('assets/home/img/blog-1.jpg') }}" alt="">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        <img class="card-img-top mb-2" src="{{ url('assets/home/img/blog-2.jpg') }}" alt="">
                        <div class="card-body bg-light text-center p-4">
                            <h4 class="">Diam amet eos at no eos</h4>
                            <div class="d-flex justify-content-center mb-3">
                                <small class="mr-3"><i class="fa fa-user text-primary"></i> Admin</small>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        <img class="card-img-top mb-2" src="{{ url('assets/home/img/blog-3.jpg') }}" alt="">
                        <div class="card-body bg-light text-center p-4">
                            <h4 class="">Diam amet eos at no eos</h4>
                            <div class="d-flex justify-content-center mb-3">
                                <small class="mr-3"><i class="fa fa-user text-primary"></i> Admin</small>
