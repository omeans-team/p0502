...
<form action="{{ route('listmenu.store') }}" method="POST">
    @csrf
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <select name="kategori" class="form-control">
                    ...
                    <option style="background-image:url( {{ url('assets/img/apple-touch-icon.png') }} );" value="{{ $obj_icon->icon_name }}">{{ $obj_icon->name }}</option>
                    <!-- <option value="{{ $obj_icon->id }}">{{ $obj_icon->name }}</option> -->
                    @endforeach
                </select>
